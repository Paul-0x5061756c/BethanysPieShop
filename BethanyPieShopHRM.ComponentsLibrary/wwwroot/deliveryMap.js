(function () {
    ...
    let tileAttribution = 'Map data &copy; <a href="https://www.openstreetmap.org/">OpenStreetMap</a> contributors, <a href="https://creativecommons.org/licenses/by-sa/2.0/">CC-BY-SA</a>';
    ...
    window.deliveryMap = {
        showOrUpdate: function (elementId, markers) {
            ...
            if (map.addedMarkers.length !== markers.length) {
                ...
                // Auto-fit the view
                let markersGroup = new L.featureGroup(map.addedMarkers);
    ...
    function animateMarkerMoveFrame(marker) {
        let anim = marker.existingAnimation;
        let proportionCompleted = (new Date().valueOf() - anim.startTime.valueOf()) / anim.durationMs;
        let coordsNow = {
